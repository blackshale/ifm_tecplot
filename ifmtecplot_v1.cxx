...
static const char szDesc[] = 
  "Write modeling results in Tecplot format";
...
IfmResult RegisterModule(IfmModule pMod)
{
  if (IfmModuleVersion (pMod) < IFM_CURRENT_MODULE_VERSION)
    return False;
  IfmRegisterModule (pMod, "SIMULATION", "IFMTECPLOT_V1", "Ifmtecplot_v1", 0x1000);
  IfmSetDescriptionString (pMod, szDesc);
  IfmSetCopyrightPath (pMod, "ifmtecplot_v1.txt");
  IfmSetHtmlPage (pMod, "ifmtecplot_v1.htm");
  IfmSetPrimarySource (pMod, "ifmtecplot_v1.cxx");
