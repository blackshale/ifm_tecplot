...
# operating system:  Linux 4.4.224 x86_64 [ELF] (4.4.224)
# libc:	(6.17.0)
# binutils:	(227)
...
.c.o:
	$(CC) -c $(CFLAGS) $(SHLIBDEF) $(SHAREDCODEDEF) $(PICFLAGS) $*.c
...
.cxx.o:
	...
	$(_NULLCMD_)
	$(RM) $@
	 	$(CXX) -c $(CXXFLAGS) $(_NOOP_) $(SHLIBDEF) $(SHAREDCODEDEF) $(CXXPICFLAGS) $*.cxx
...
.cxx.o:
   ...
   CXXPROTO_DEFINES =
    CXXSTD_INCLUDES =
  CXXEXTRA_INCLUDES = #-I/usr/local/lib/g++-include
    CXXIDL_INCLUDES = -I$(TOP)/include
     CXXSTD_DEFINES = -Dlinux -D__amd64__ -D_POSIX_C_SOURCE=199309L 				-D_POSIX_SOURCE -D_XOPEN_SOURCE 				-D_BSD_SOURCE -D_SVID_SOURCE                                 -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64
         CXXOPTIONS =
        CXXINCLUDES = $(INCLUDES) $(TOP_INCLUDES) $(CXXSTD_INCLUDES) $(CXXEXTRA_INCLUDES) $(CXXIDL_INCLUDES)
         CXXDEFINES = $(DEFINES) $(CXXPROTO_DEFINES) $(CXXINCLUDES) $(CXXSTD_DEFINES) $(THREADS_CXXDEFINES) $(CXXEXTRA_DEFINES)
           CXXFLAGS = $(CXXDEBUGFLAGS) $(CXXOPTIONS) $(THREADS_CXXFLAGS) $(CXXDEFINES)
EXTRA_CXXLOAD_FLAGS =
CXX_DEPEND_INCLUDES = -I/usr/local/lib/g++-include
       CXXLDOPTIONS = $(CXXDEBUGFLAGS) $(CXXOPTIONS) $(LOCAL_CXXLDFLAGS) -L$(USRLIBDIR)

            CXXLINK = $(CXX)

.cxx.o:
	$(CXX) -c $(CXXFLAGS) $(SHLIBDEF) $(SHAREDCODEDEF) $(PICFLAGS) $*.cxx
        ...
        CXXPICFLAGS = $(PICFLAGS)
                 LD = g++

             RPCGEN = rpcgen

# -- IFM specific environment (assuming IFMDIR is set!)

             IFMDIR = /opt/wasy/sdk/ifm/

             IFMINC = -I$(IFMDIR)/include -I$(IFMDIR)/include/xdk
             IFMLIB = -L$(IFMDIR)/lib -lifm
          DEPIFMLIB = $(IFMDIR)/lib/libifm.a

# ---- End Ifm.tmpl -----

# -- IFM_BEGIN (Begin of IFM maintained section) --------------

           THISFILE = "./Imakefile"

            IFCNAME = SIMULATION
            MODNAME = IFMTECPLOT_V1
            DPYNAME = Ifmtecplot_v1

            PRIMSRC = ifmtecplot_v1.cxx
            DSONAME = ifmtecplot_v1.so
             DSOREV = 1

            REGPROC = RegisterModule
           HTMLFILE = ifmtecplot_v1.htm
          COPYRIGHT = ifmtecplot_v1.txt
      ...
      IFMDEBUGFLAGS = -g
        IFMINCLUDES = -I. $(IFMINC)
         ...
         IFMDEPLIBS =  $(DEPIFMLIB)
            ...
            IFMOBJS = ifmtecplot_v1.o
            IFMSRCS = $(PRIMSRC)

# -- IFM_END (End of IFM maintained section) ------------------
...
$(DSONAME).$(DSOREV) $(DSONAME): $(OBJS) $(DEPLIBS)
	$(RM) $(DSONAME).$(DSOREV) $(DSONAME)
	$(CXXLINK) -o $(DSONAME).$(DSOREV) $(SHLIBLDFLAGS) -Wl,-Bsymbolic $(IFMLDFLAGS) $(LDOPTIONS) $(OBJS) $(LIBS) $(LDLIBS)  $(EXTRA_LOAD_FLAGS) $(SYSLIBS)
	$(LN) $(DSONAME).$(DSOREV) $(DSONAME)
cleandir::
	$(RM) $(DSONAME).$(DSOREV) $(DSONAME)
...
# DO NOT DELETE
ifmtecplot_v1.o: ifmtecplot_v1.cxx /usr/include/stdc-predef.h \
 /opt/wasy/sdk/ifm//include/ifm/module.h \
 /opt/wasy/sdk/ifm//include/ifm/graphic.h \
 /opt/wasy/sdk/ifm//include/xdk/X11/Intrinsic.h \
 /opt/wasy/sdk/ifm//include/xdk/X11/Xlib.h /usr/include/sys/types.h \
 ...
 /opt/wasy/sdk/ifm//include/xdk/X11/X.h \
 /opt/wasy/sdk/ifm//include/xdk/X11/Xfuncproto.h \
 /opt/wasy/sdk/ifm//include/xdk/X11/Xosdefs.h \
 /opt/wasy/sdk/ifm//include/xdk/X11/Xutil.h \
 /opt/wasy/sdk/ifm//include/xdk/X11/Xresource.h /usr/include/string.h \
 /usr/include/xlocale.h /opt/wasy/sdk/ifm//include/xdk/X11/Core.h \
 /opt/wasy/sdk/ifm//include/xdk/X11/Composite.h \
 /opt/wasy/sdk/ifm//include/xdk/X11/Constraint.h \
 /opt/wasy/sdk/ifm//include/xdk/X11/Object.h \
 /opt/wasy/sdk/ifm//include/xdk/X11/RectObj.h \
 /opt/wasy/sdk/ifm//include/ifm/module.h \
 /opt/wasy/sdk/ifm//include/ifm/document.h \
 /opt/wasy/sdk/ifm//include/ifm/graphic.h \
 /opt/wasy/sdk/ifm//include/ifm/archive.h \
 /opt/wasy/sdk/ifm//include/ifm/xdk.h /usr/include/c++/4.8.2/vector \
 ...
 /usr/include/c++/4.8.2/bits/stl_multimap.h /usr/include/c++/4.8.2/string \
